...
//                      Selenium tests. AngularJS version.
...
namespace Selenium.Wrappers
{
    ...
    public class DataTable
    {
        ...
        /// </summary>
        private NgWebDriver Driver { get; set; }
        ...
        /// </returns>
        public NgWebElement GetRowElement(string text)
        {
            // Get the <table> element for this widget.
            var wrapper = this.Driver.FindElement(this.Selector);
        ...
        /// Returns the table row element.
        /// </returns>
        public NgWebElement GetRowElement(int index)
        {
            // Get the <table> element for this widget.
            var wrapper = this.Driver.FindElement(this.Selector);
        ...
        /// </param>
        public DataTable(NgWebDriver driver, By selector)
        {
            this.Driver = driver;
